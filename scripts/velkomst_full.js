...
async function main() {
  const meldinger = fs
    .readFileSync("messages/meldinger_vanleg.txt", "utf-8")
    .split("\n")
    .filter((l) => l.trim() !== "");
  ...
  const fulltext = `${melding} I dag er det ${weekday} ${date}, og klokka er ${time}. Hjertelig velkommen heim ❤️`;
  console.log("🎙️ Genererer velkomst full:", fulltext);
